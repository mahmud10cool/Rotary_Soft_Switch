...
MAKECMD         = /common/software/install/manual/matlab/R2023b/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = trial_with_intermediate_tanks
MODULES                 = rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c trial_with_intermediate_tanks.c trial_with_intermediate_tanks_capi.c trial_with_intermediate_tanks_data.c trial_with_intermediate_tanks_tgtconn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = trial_with_intermediate_tanks
MAKEFILE                = trial_with_intermediate_tanks.mk
MATLAB_ROOT             = /common/software/install/manual/matlab/R2023b
ALT_MATLAB_ROOT         = /common/software/install/manual/matlab/R2023b
START_DIR               = /panfs/jay/groups/1/lixxx099/ibrah408/Rotary_system_git/ROTARY\ SYSTEM/REALLY\ USEFUL\ STUFF\ 23B
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 27
COMPUTER                = GLNXA64
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="/common/software/install/manual/matlab/R2023b" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
ADDITIONAL_LDFLAGS      =  -Wl,--allow-shlib-undefined -Wl,-rpath,/common/software/install/manual/matlab/R2023b/sys/os/glnxa64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/trial_with_intermediate_tanks \
